...
<!-- Projects Section-->
<section class="p-5">
	<h1 class="mb-5">Daftar Data Siswa</h1>
	<a class="btn btn-primary" href="pages/create.php">Tambah Data Siswa</a>
	<table class="table table table-striped table-bordered">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
				<a href="edit_siswa.php?id=<?php echo $d['nisn']; ?>" class="edit-btn">Edit</a>
				<a href="hapus.php?id=<?php echo $d['nisn']; ?>" class="delete-btn">Delete</a>
				</td>
			</tr>
			<?php 
		}
